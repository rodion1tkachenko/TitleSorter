Task of this application is to sort photos which set at first directory. Photos are analyzed by their names in format "в* #", where * is a variant and # is solved tasks. 
